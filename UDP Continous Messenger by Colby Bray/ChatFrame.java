/*
 ...
 This class provides the frame of the message chatroom.
 */
import java.awt.*;
import javax.swing.*;
...
public class ChatFrame extends JFrame implements ActionListener {
    ...
    public ChatFrame(User user, String from, String to, boolean centre) {
        ...
        chatPanel.setBackground(new Color(202, 200, 200));
        chatPanel.setBounds(1, 50, WIDTH, HEIGHT - 50);
        chatPanel.setVisible(true);

        contactPanel = new JPanel();
        contactPanel.setLayout(null);
        contactPanel.setBackground(new Color(137, 133, 133));
        ...
        textArea.setBackground(new Color(205, 204, 204));
        textArea.setText("");
